...
### ステップ 2 — MCP Server のインストール（FlopAI プラグイン）

本 Power は [flopperam/unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp) を使用します — 9 ドメインにわたる 50+ ツールを備えた最先端の UE MCP Server。UE 5.5 / 5.6 / 5.7 対応。
...
3. Unreal Editor でプラグインが動作していることを確認

### ステップ 3 — MCP 接続を設定

`mcp.json` または `.kiro/settings/mcp.json` を編集：

**方法 A：Hosted Flop MCP（推奨）**
...
> **注意**：ローカル版は基本ツールセットのみ提供します。完全な 50+ ツール体験には Hosted 版をご利用ください。
