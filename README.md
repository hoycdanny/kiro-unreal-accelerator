...
- Kiro IDE
- Unreal Engine 5.x（需開啟 Editor 並啟用 MCP Server Plugin）
- Node.js 18+
...
在 `.kiro/settings/mcp.json` 中確認 `unreal-engine` server 已設定：
...
**Q: MCP 連線失敗？**
1. 確認 Unreal Editor 已開啟
2. 確認 MCP Server Plugin 已啟用
3. 檢查 `.kiro/settings/mcp.json` 設定
